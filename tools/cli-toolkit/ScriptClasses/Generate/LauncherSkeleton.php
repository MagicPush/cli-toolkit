...
class LauncherSkeleton extends CliToolkitGenerateScriptAbstract {
    ...
    protected function generateScriptClassesLauncher(): static {
        ...
        $launcherSubstitutes = [
            ...
            '%%PARAMETER_LIST%%'                => Config::PARAMETER_NAME_LIST,
         ...
         *  'php {$this->generatedLauncherPath} %%PARAMETER_LIST%%'
         ...
         *  Thus, it is save to just remove 'throwOnException: true' from the line below.
         *  --
        ...
        (new {$launcherClassShortName}(\$scriptClassDetector))
             ...
             *  Thus, it's save to just remove '->throwOnException(false)' line.
             *  --
             ...
             *  (and only if you explicitly create such config files), but in the current library version no supported
             *  environment settings may affect any of your scripts logic.
             *  --
    ...
    protected function generateCompletionsGenerator(): static {
        ...
        # %%DO%% 1. You should generate the completion script each time you make relevant changes (or build a container)
